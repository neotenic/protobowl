...
var actionMode, addAnnotation, addImportant, avg, changeQuestion, chatAnnotation, checkAlone, computeScore, compute_sync_offset, connected, createAlert, createBundle, createStatSheet, cumsum, ding_sound, formatTime, guessAnnotation, handleCacheEvent, inner_socket, lastRendering, last_question, latency_log, mobileLayout, next, public_id, public_name, public_rooms, rate_limit_ceiling, rate_limit_check, recent_actions, removeSplash, renderPartial, renderState, renderTimer, serverTime, setActionMode, skip, sock, stdev, sum, sync, sync_offset, sync_offsets, synchronize, testLatency, time, updateTextAnnotations, updateTextPosition, userSpan, users,
