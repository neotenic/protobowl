...
sock.on('disconnect', function() {
  ...
  line.append($('<p>').append("This may be due to a drop in the network 			connectivity or a malfunction in the server. The client will automatically 			attempt to reconnect to the server and in the mean time, the app has automatically transitioned			into offline mode. However, you might want to try <a href=''>reloading</a>."));
...
renderPartial = function() {
  var bundle, buzz, children, cumulative, del, element, elements, i, index, label_type, new_text, old_spots, old_text, spots, timeDelta, unread, visible, words, wpm, _i, _j, _ref, _ref1;
