...
synchronize = function(data) {
  var attr, below, cat, dif, item, thresh, _i, _j, _len, _len1, _ref, _ref1;
  if (data) {
...
renderPartial = function() {
  ...
  renderTimer();
  if (sync.attempt) {
    return guessAnnotation(sync.attempt);
  }
};

updateTextAnnotations = function() {
  var bundle, children, element, elements, i, label_type, readout, spots, words, _i, _j, _ref, _ref1, _results;
