...
var actionMode, addAnnotation, addImportant, avg, changeQuestion, chatAnnotation, checkAnswer, computeScore, connected, createBundle, createStatSheet, cumsum, fisher_yates, formatTime, guessAnnotation, inner_socket, last_question, latency_log, mobileLayout, public_id, public_name, removeSplash, renderPartial, renderState, renderTimer, serverTime, setActionMode, sock, stdev, sync, sync_offset, sync_offsets, synchronize, testLatency, time, userSpan, users, virtual_server,
...
checkAnswer = function(attempt, correct) {
  attempt.toLowerCase();
...
virtual_server = {
  ...
  new_question: function() {
    ...
    syllables = function(word) {
      return Math.round(word.length * 0.35636480798038367);
    };
    ...
    cumulative = cumsum(this.timing, this.rate);
...
connected = function() {
  return inner_socket.socket.connected;
};
