...
var TestingQuestion, addAnnotation, avg, chatAnnotation, createBundle, cumsum, generateName, n, public_name, renderState, sock, sync, sync_offset, sync_offsets, time, transitionQuestion,
...
TestingQuestion = {
  "category": "Trash",
  "pKey": "His creation is attributed to either Bill Finger or Jerry Robinson, with the distinctive look based partly on the look of actor Conrad Veidt in one film. This man, perhaps originally Red Hood, is cred",
  "difficulty": "HS",
  "tournament": "QuAC I",
  "question": "His creation is attributed to either Bill Finger or Jerry Robinson, with the distinctive look based partly on the look of actor Conrad Veidt in one film. This man, perhaps originally Red Hood, is credited with killing Sarah Gordon and Jason Todd as well as permanently injuring Oracle, while another story sees his psychiatrist Harleen Quinzl falling in love with him and attempting to feed his arch-nemesis to piranhas. In television and movies, he's been played by Cesar Romero and Jack Nicholson. For 10 points name this fictional villain more recently played by Heath Ledger, a nemesis of the Batman.",
  "accept": null,
  "question_num": 12,
  "year": 2008,
  "answer": "The Joker",
  "round": "Round1Final.doc"
};
