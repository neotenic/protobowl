...
var actionMode, addAnnotation, avg, changeQuestion, chatAnnotation, computeScore, createBundle, cumsum, guessAnnotation, last_question, latency_log, mobileLayout, public_id, public_name, renderPartial, renderState, renderTimer, serverTime, setActionMode, sock, stdev, sync, sync_offset, sync_offsets, synchronize, testLatency, time, userSpan, users,
...
renderPartial = function() {
  ...
  if (sync.question !== last_question) {
    changeQuestion();
    if (!last_question && sync.time_freeze) {
      console.log('blank');
    }
