...
var Cookies, Question, QuestionSchema, QuizRoom, app, categories, checkAnswer, clearInactive, countCache, countQuestions, crypto, cumsum, db, difficulties, error_question, express, fisher_yates, fs, getQuestion, http, io, log, mongoose, parseCookie, port, rooms, scheduledUpdate, sha1, syllables, updateCache, uptime_begin, watcher,
...
clearInactive = function(threshold) {
  ...
  for (name in rooms) {
    ...
    if (len === 0) {
      ...
      _results.push(delete rooms[name]);
    } else {
