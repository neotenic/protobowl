...
var Cookies, QuizRoom, app, checkAnswer, clearInactive, crypto, cumsum, express, fs, full_journal_sync, http, io, journal, journal_config, journal_queue, log, log_config, names, parseCookie, partial_journal, port, process_journal_queue, reaped, restore_journal, rooms, scheduledUpdate, sha1, syllables, updateCache, uptime_begin, url, watcher,
...
if (app.settings.env === 'development') {
  ...
  watcher = function(event, filename) {
    if ((filename === "offline.appcache" || filename === "web.js" || filename === "web.coffee" || filename === "config.coffee" || filename === "config.js") || /\.css$/.test(filename)) {
      return;
    }
